...
// refuse a managed credential source outright rather than quietly forwarding
// what would have to be the customer's root API key inside a signed plan.
//
// # Regions
//
